...
\begin{problem}{January 2011}{}
  Let $\Phi$ be the Cantor's function
 and let $\mu_{\Phi}$ be the corresponding Lebesgue-Stiltjes measure.
 Calculate the integral
 \[
 \int_{[0,1]} x d \mu_{\Phi}.
 \]

\end{problem}

\begin{problem}{January 2011}{}
 Let $f \in L_1([0,1])$ be a function such that $\int_E f \, dm=0$ for any $E \subset [0,1]$ with $m(E)=1/2$. Prove that $f=0$.
\end{problem}
